...
This pipeline was written by Lonneke Scheffer. This repository is a history-free
import of the original development repository; the commit history has been condensed
into a single initial commit, which retains her authorship.

If you use this pipeline, please cite the preprint:
[Revised Adaptive Immune Receptor Data in the Immune Epitope Database](https://doi.org/10.64898/2026.06.03.728549).

## License

Copyright (c) 2026 La Jolla Institute for Immunology
